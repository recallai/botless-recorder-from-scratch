...
const sourceFile = resolve(projectRoot, "native", "macos-window-probe", "main.swift");
...
const targetBinary = resolve(outputDirectory, "macos-window-probe");
...
if (!existsSync(targetBinary)) {
  throw new Error(`Expected native window probe at ${targetBinary}`);
}
